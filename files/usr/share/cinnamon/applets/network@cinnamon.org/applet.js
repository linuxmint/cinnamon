...
function ssidToLabel(ssid) {
    let label = NM.utils_ssid_to_utf8(ssid);
    if (!label)
        label = _("<unknown>");
    return label;
}
...
NMNetworkMenuItem.prototype = {
    ...
    _init: function(accessPoints, title, params) {
        ...
        if (!title) {
            let ssid = this.bestAP.get_ssid().get_data();
...
NMDevice.prototype = {
    ...
    deactivate: function() {
        this.device.disconnect_async(null, Lang.bind(this, function() {}));
    },
...
NMDeviceWireless.prototype = {
    ...
    activate: function() {
        ...
        if (best) {
            for (let i = 0; i < bestApObj.accessPoints.length; i++) {
                ...
                if (ap.connection_valid(best)) {
                    this._client.activate_connection_async(best, this.device, ap.get_path(), null, null);
                    break;
                }
            }
            return;
        ...
        if (this._networks.length > 0) {
            ...
            this._client.add_and_activate_connection_async(connection, this.device, accessPoints[0].get_path(), null, null);
        }
    },
...
**/
    ...
    _accessPointAdded: function(device, accessPoint) {
        ...
        if (pos != -1) {
            ...
            apObj = { ssid: accessPoint.get_ssid().get_data(),
        ...
        item.connect('activate', Lang.bind(this, function() {
            ...
            for (let i = 0; i < accessPoints.length; i++) {
                if (accessPoints[i].connection_valid(connection)) {
                    this._client.activate_connection_async(connection, this.device, accessPoints[i].get_path(), null, null);
                    break;
                }
            }
        }));
            ...
            apObj.item.connect('activate', Lang.bind(this, function() {
                ...
                if ((accessPoints[0]._secType == NMAccessPointSecurity.WPA2_ENT) ||
                    ...
                    Util.spawn(['cinnamon-settings', 'network', 'connect-8021x-wifi',
                                this.device.get_path(), accessPoints[0].get_path()]);
                } else {
...
CinnamonNetworkApplet.prototype = {
        ...
        try {
            ...
            this.rescan_item.connect("activate", Lang.bind(this, function() {
                ...
                for (let device of devices) {
                    device.device.request_scan(null);
                }
            }));
    ...
    _syncActiveConnections: function() {
        ...
        for (let i = 0; i < this._activeConnections.length; i++) {
            ...
            if (!a._connection) {
                a._connection = a.get_connection();
            ...
            else if (a.state == NM.ActiveConnectionState.ACTIVATING) {
                activating = a;
            }
    ...
    _readConnections: function() {
        ...
        for (let connection of connections) {
            ...
            connection._changedId = connection.connect('changed', Lang.bind(this, this._connectionChanged));

            this._connectionChanged(connection);
    ...
    _connectionRemoved: function(client, connection) {
        ...
        connection.disconnect(connection._changedId);
    },
    ...
    _connectionChanged: function(connection) {
        ...
        connection._type = connectionSettings.get_connection_type();

        connection._section = this._ctypes[connection._type] || NMConnectionCategory.INVALID;
        connection._name = connectionSettings.get_id();
        connection._uuid = connectionSettings.get_uuid();
        connection._timestamp = connectionSettings.get_timestamp();
        ...
        if (section == NMConnectionCategory.INVALID)
            ...
            let devices = this._devices[section].devices;
            for (let device of devices) {
                device.checkConnection(connection);
            }
        }
    },
                ...
                case NMConnectionCategory.WIRELESS:
                    ...
                    if (dev) {
                        ...
                        if (!ap) {
                            ...
                            this.set_applet_tooltip(_("Wireless connection") + ": " + ap.get_ssid().get_data() + " ("+ ap.strength +"%)");
                        }
                    } else {
