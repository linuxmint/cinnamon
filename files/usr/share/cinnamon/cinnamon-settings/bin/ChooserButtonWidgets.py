...
class TimeChooserDialog(Gtk.Dialog):
    def __init__(self, time, window, use_seconds, use24hour):
        ...
        for ttype, column in unit_defs:
            ...
            up_button = Gtk.Button.new_from_icon_name('xapp-pan-up-symbolic', Gtk.IconSize.DIALOG)
            down_button = Gtk.Button.new_from_icon_name('xapp-pan-down-symbolic', Gtk.IconSize.DIALOG)
