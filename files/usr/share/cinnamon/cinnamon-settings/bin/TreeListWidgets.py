...
class List(SettingsWidget):
    ...
    def __init__(self, label=None, columns=None, height=200, size_group=None, \
        ...
        if show_buttons:
            ...
            self.add_button.set_icon_name("xapp-list-add-symbolic")
            ...
            self.remove_button.set_icon_name("xapp-list-remove-symbolic")
            ...
            self.edit_button.set_icon_name("xapp-list-edit-symbolic")
            ...
            self.move_up_button.set_icon_name("xapp-go-up-symbolic")
            ...
            self.move_down_button.set_icon_name("xapp-go-down-symbolic")
