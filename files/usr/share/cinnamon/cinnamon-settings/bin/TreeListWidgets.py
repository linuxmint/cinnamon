...
class List(SettingsWidget):
    ...
    def __init__(
        ...
        for i in range(len(columns)):
            ...
            has_option_map = "options" in column_def and isinstance(
                column_def["options"], dict
            )
            ...
            if has_option_map:
                ...
                column.set_cell_data_func(
                    renderer, map_func, [column_def["options"], i]
                )
            else:
        ...
        self.content_widget.get_selection().connect(
            "changed", self.update_button_sensitivity
        )
