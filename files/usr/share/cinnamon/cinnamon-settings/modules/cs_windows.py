...
class Module:
    ...
    def __init__(self, content_box):
        keywords = _(
            "windows, titlebar, edge, switcher, window list, attention, focus, tile, tiling, snap, snapping"
        )
        sidePage = SidePage(
            _("Windows"), "cs-windows", keywords, content_box, module=self
        )
    ...
    def on_module_selected(self):
        if not self.loaded:
            ...
            action_options = [
                ...
                ["toggle-stuck", _("Toggle on all workspaces")],
                ["toggle-above", _("Toggle always on top")],
                ["minimize", _("Minimize")],
                ["menu", _("Menu")],
                ["lower", _("Lower")],
                ["none", _("None")],
            ...
            widget = GSettingsComboBox(
                _("Action on title bar double-click"),
                "org.cinnamon.desktop.wm.preferences",
            ...
            widget = GSettingsComboBox(
                _("Action on title bar middle-click"),
                "org.cinnamon.desktop.wm.preferences",
            ...
            widget = GSettingsComboBox(
                _("Action on title bar right-click"),
                "org.cinnamon.desktop.wm.preferences",
            ...
            widget = GSettingsSwitch(
                _("Automatically raise focused windows"),
                "org.cinnamon.desktop.wm.preferences",
                "auto-raise",
            )
            settings.add_reveal_row(widget)

            widget.revealer.settings = Gio.Settings(
                "org.cinnamon.desktop.wm.preferences"
            )
            widget.revealer.settings.bind_with_mapping(
                "focus-mode",
                widget.revealer,
                "reveal-child",
                Gio.SettingsBindFlags.GET,
                lambda x: x in ("sloppy", "mouse"),
                None,
            )
            ...
            widget.set_tooltip_text(
                _(
                    "Normally, all windows created by the user are given initial focus. "
            ...
            def update_switch(settings, key):
                if self.updating:
                    return
                self.updating = True
                real_switch.set_active(
                    gsettings.get_enum(key) == CDesktopEnums.FocusNewWindows.SMART
                )
                self.updating = False
            ...
            def update_setting(widget, pspec):
                ...
                gsettings.set_enum(
                    "focus-new-windows",
                    CDesktopEnums.FocusNewWindows.SMART
                    if real_switch.get_active()
                    else CDesktopEnums.FocusNewWindows.STRICT,
                )
                self.updating = False
            ...
            widget = GSettingsComboBox(
                _("Location of newly opened windows"),
                "org.cinnamon.muffin",
                "placement-mode",
                placement_options,
                size_group=size_group,
            ...
            widget.content_widget.set_tooltip_text(
                _(
                    "This adjusts the width of that portion of the window border used for resizing."
                )
            )
            ...
            widget = GSettingsSwitch(
                _("Move minimized windows to the end of the alt-tab switcher"),
                "org.cinnamon",
                "alttab-minimized-aware",
            )
            settings.add_row(widget)
            ...
            widget = GSettingsSwitch(
                ...
                "org.cinnamon",
                "alttab-switcher-show-all-workspaces",
            )
            settings.add_row(widget)

            widget = GSettingsSwitch(
                _("Show windows from current monitor"),
                "org.cinnamon",
                "alttab-switcher-show-current-monitor",
            )
            settings.add_row(widget)

            widget = GSettingsSwitch(
                _("Warp mouse pointer to the new focused window"),
                "org.cinnamon",
                "alttab-switcher-warp-mouse-pointer",
            )
            settings.add_row(widget)
            ...
            switch = GSettingsSwitch(
                _("Enable window tiling"), "org.cinnamon.muffin", "edge-tiling"
            )
            settings.add_row(switch)
            switch = GSettingsSwitch(
                _("Maximize, instead of tile, when dragging a window to the top edge"),
                "org.cinnamon.muffin",
                "tile-maximize",
            )
