...
class Module:
    ...
    def __init__(self, content_box):
        ...
        sidePage = SidePage(
            _("General"), "cs-general", keywords, content_box, module=self
        )
    ...
    def on_module_selected(self):
        if not self.loaded:
            ...
            switch = GSettingsSwitch(
                _("Disable compositing for full-screen windows"),
                "org.cinnamon.muffin",
            ...
            switch = GSettingsSwitch(
                _("Enable timer when logging out or shutting down"),
            ...
            settings.add_reveal_row(
                spin, "org.cinnamon.SessionManager", "quit-delay-toggle"
            )
            ...
            if util.get_session_type() != "wayland":
                ...
                switch = GSettingsSwitch(
                    _("Restart Cinnamon when it uses too much memory"),
                ...
                settings.add_reveal_row(
                    spin, "org.cinnamon.launcher", "memory-limit-enabled"
                )
