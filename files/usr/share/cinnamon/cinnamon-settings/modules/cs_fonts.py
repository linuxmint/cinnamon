...
class Module:
    ...
    def __init__(self, content_box):
        ...
        sidePage = SidePage(
            _("Font Selection"), "cs-fonts", keywords, content_box, module=self
        )
    ...
    def on_module_selected(self):
        if not self.loaded:
            ...
            widget = GSettingsFontButton(
                _("Desktop font"), "org.nemo.desktop", "font", size_group=size_group
            )
            settings.add_row(widget)
            ...
            widget.set_tooltip_text(
                _("Hinting allows for producing clear, legible text on screen.")
            )
            settings.add_row(widget)
            ...
            widget.set_tooltip_text(
                _("Antialiasing makes on screen text smoother and easier to read")
            )
            settings.add_row(widget)
