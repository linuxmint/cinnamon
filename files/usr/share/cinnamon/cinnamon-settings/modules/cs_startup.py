...
class AutostartBox(Gtk.Box):
    def __init__(self, title):
        ...
        self.add_button = Gtk.Button.new_from_icon_name("xapp-list-add-symbolic", Gtk.IconSize.BUTTON)
        self.add_button.set_tooltip_text(_("Add"))
        self.add_button.connect("clicked", self.on_add_button_clicked)
        button_group.add_widget(self.add_button)
        box.add(self.add_button)

        self.edit_button = Gtk.Button.new_from_icon_name("xapp-document-edit-symbolic", Gtk.IconSize.BUTTON)
        ...
        self.remove_button = Gtk.Button.new_from_icon_name("xapp-list-remove-symbolic", Gtk.IconSize.BUTTON)
        ...
        self.run_button = Gtk.Button.new_from_icon_name("xapp-media-playback-start-symbolic", Gtk.IconSize.BUTTON)
