...
class Module:
    ...
    def __init__(self, content_box):
        ...
        sidePage = SidePage(
            _("Effects"), "cs-desktop-effects", keywords, content_box, module=self
        )
    ...
    def on_module_selected(self):
        if not self.loaded:
            ...
            settings = page.add_reveal_section(
                "", "org.cinnamon", "desktop-effects-workspace"
            )

            widget = GSettingsSwitch(
                _("Effects on dialog boxes"),
                "org.cinnamon",
            ...
            widget = GSettingsSwitch(
                _("Effects on menus"), "org.cinnamon", "desktop-effects-on-menus"
            )
            settings.add_reveal_row(widget, "org.cinnamon", "desktop-effects-workspace")

            widget = GSettingsSwitch(
                _("Session startup animation"), "org.cinnamon", "startup-animation"
            )
            settings.add_reveal_row(widget, "org.cinnamon", "desktop-effects-workspace")
            ...
            widget = GSettingsComboBox(
                _("New windows or unminimizing existing ones"),
                "org.cinnamon",
                "desktop-effects-map",
                options,
            )
            ...
            widget = GSettingsComboBox(
                _("Closing windows"), "org.cinnamon", "desktop-effects-close", options
            )
            settings.add_reveal_row(widget, "org.cinnamon", "desktop-effects")
            ...
            widget = GSettingsComboBox(
                _("Minimizing windows"),
                "org.cinnamon",
                "desktop-effects-minimize",
                options,
            )
            settings.add_reveal_row(widget, "org.cinnamon", "desktop-effects")
            ...
            widget = GSettingsSwitch(
                _("Resizing and tiling windows"),
                "org.cinnamon",
                "desktop-effects-change-size",
            )
            settings.add_reveal_row(widget, "org.cinnamon", "desktop-effects")

            slider = GSettingsRange(
                _("Window animation speed"),
                "org.cinnamon",
                "window-effect-speed",
                _("Slower"),
                _("Faster"),
