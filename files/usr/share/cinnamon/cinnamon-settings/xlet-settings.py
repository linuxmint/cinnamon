...
class MainWindow(object):
    ...
    def build_window(self):
        ...
        self.prev_button = Gtk.Button.new_from_icon_name('xapp-go-previous-symbolic', Gtk.IconSize.BUTTON)
        self.prev_button.set_tooltip_text(_("Previous instance"))
        instance_button_box.add(self.prev_button)

        self.next_button = Gtk.Button.new_from_icon_name('xapp-go-next-symbolic', Gtk.IconSize.BUTTON)
        ...
        image = Gtk.Image.new_from_icon_name("xapp-open-menu-symbolic", Gtk.IconSize.BUTTON)
