...
class MainWindow:
    ...
    def __init__(self):
        ...
        self.builder.add_from_file(
            "/usr/share/cinnamon/cinnamon-screensaver-lock-dialog/cinnamon-screensaver-lock-dialog.ui"
        )
        ...
        self.builder.get_object("label_description").set_markup(
            "<i>%s</i>" % _("Please type an away message for the lock screen")
        )
        ...
        self.builder.get_object("dialog-action_area1").set_focus_chain(
