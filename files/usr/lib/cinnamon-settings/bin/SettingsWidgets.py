...
class SidePage:
    def __init__(self, name, icon, keywords, tooltip, content_box, is_c_mod = False, is_standalone = False, exec_name = None):
        self.name = name
        self.icon = icon
...
class CCModule:
    def __init__(self, label, mod_id, icon, category, keywords, tooltip, content_box):
        sidePage = SidePage(label, icon, keywords, tooltip, content_box, True, False, None)
...
class SAModule:
    def __init__(self, label, mod_id, icon, category, keywords, tooltip, content_box):
        sidePage = SidePage(label, icon, keywords, tooltip, content_box, False, True, mod_id)
        self.sidePage = sidePage
        self.name = mod_id
        self.category = category
