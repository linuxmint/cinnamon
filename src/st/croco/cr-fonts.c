 ...
 * @a_walk_font_family_list: whether to serialize the entire list.
 *
 * Returns the serialized font family. The caller has to free it using
 * g_free().
 */
guchar *
