...
{
  CinnamonMimeSniffer *self = state->self;
  GArray *results;
...
static void
deep_count_start (CinnamonMimeSniffer *self)
{
  DeepCountState *state;
                           ...
                           gpointer user_data)
{
  GFileInfo *info;
  GError *error = NULL;
  CinnamonMimeSniffer *self = user_data;
...
static void
start_loading_file (CinnamonMimeSniffer *self)
{
...
static void
cinnamon_mime_sniffer_set_file (CinnamonMimeSniffer *self,
                            GFile *file)
{
...
static void
cinnamon_mime_sniffer_dispose (GObject *object)
{
...
static void
cinnamon_mime_sniffer_set_property (GObject *object,
                                guint       prop_id,
                                const GValue *value,
                                GParamSpec *pspec)
{
  ...
  switch (prop_id) {
  case PROP_FILE:
    cinnamon_mime_sniffer_set_file (self, g_value_get_object (value));
    break;
  default:
    G_OBJECT_WARN_INVALID_PROPERTY_ID (object, prop_id, pspec);
    break;
...
static void
cinnamon_mime_sniffer_class_init (CinnamonMimeSnifferClass *klass)
{
  GObjectClass *oclass;
...
CinnamonMimeSniffer *
cinnamon_mime_sniffer_new (GFile *file)
{
...
void
cinnamon_mime_sniffer_sniff_async (CinnamonMimeSniffer *self,
                                ...
                                gpointer user_data)
{
  ...
  g_source_set_name_by_id (self->priv->watchdog_id, "[cinnamon] watchdog_timeout_reached_cb");

  start_loading_file (self);
}

gchar **
cinnamon_mime_sniffer_sniff_finish (CinnamonMimeSniffer *self,
                                 GAsyncResult *res,
                                 GError **error)
{
