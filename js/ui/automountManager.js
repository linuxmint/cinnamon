...
const ConsoleKitSessionIface = <interface name="org.org.freedesktop.ConsoleKit.Session">
...
function ConsoleKitManager() {
    ...
    self.connect('notify::g-name-owner', function() {
        if (self.g_name_owner) {
            self.GetCurrentSessionRemote(function(result, excp) {
                let [session] = result;
                self._ckSession = new ConsoleKitSEssionProxy(Gio.DBus.system, "org.freedesktop.ConsoleKit", session);

                self._ckSession.connectSignal('ActiveChanged', function(object, isActive) {
                    this.sessionActive = isActive;
                });
                self._ckSession.IsActiveRemote( function(result) {
                    let [isActive] = result;
                    this.sessionActive = isActive;          
                });
            });
