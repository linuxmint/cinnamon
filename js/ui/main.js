...
function start() {
    ...
    // Cinnamon's own chrome. (overlay_group is muffin's feedback group under
    // another name - the actor where it parents its MetaFeedbackActors - so
    // this is also where compositor-positioned surfaces like the candidate
    // popup end up.)
