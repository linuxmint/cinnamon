...
// key: Separated chars, value: regex containing ligatures to be separated
 ...
 *
 * Returns (string): @string, string with accents removed and ligatures replaced
 */
function latinise(string){
    //remove accents
    string = string.normalize('NFD').replace(/[\u0300-\u036f]/g, '');
    
    //decompose ligatures into separate chars
